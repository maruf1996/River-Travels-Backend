...
CREATE TABLE "launch_details" (
    ...
    "chair_coach_seat" TEXT NOT NULL,
    "chair_coach_fare" TEXT NOT NULL,
    "single_cabin_seat" TEXT NOT NULL,
    "single_cabin_fare" TEXT NOT NULL,
    "vip_cabin_seat" TEXT NOT NULL,
    "vip_cabin_fare" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
